...
class _EditAccountScreenState extends ConsumerState<EditAccountScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await ref.read(accountsNotifierProvider.notifier).updateAccount(updated);

      if (mounted) {
        context.pop();
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Account updated!', style: GoogleFonts.poppins()),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Editing the balance here directly adjusts the account. '
                  'To record money coming in or going out, use a transaction instead.',
                  style: GoogleFonts.poppins(
                    fontSize: 11,
                    color: Theme.of(
                      context,
